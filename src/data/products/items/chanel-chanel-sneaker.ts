...
export const ChanelChanelSneakerProduct: Product = {
  id: 'product-032',
  slug: 'chanel-chanel-sneaker',
  name: 'Chanel Sneaker',
  brand: 'chanel',
  category: 'shoes',
  description: 'Chanel Sneaker is presented as part of the current shoe catalog, combining recognizable branding, wearable comfort and standout styling for everyday fashion use.',
  flylinkUrl: 'https://store.flylinking.com/g/DQDIOJ3T1L',
  variants: [
    {
      color: 'Black',
      images: [
