...
export const BalenciagaBalenciagaRunnerSneaker70Product: Product = {
  id: 'product-011',
  slug: 'balenciaga-balenciaga-runner-sneaker-7-0',
  name: 'Balenciaga Runner Sneaker 7.0',
  brand: 'balenciaga',
  category: 'shoes',
  description: 'A signature design reflecting Demna’s distinctive sneaker aesthetic, combining deliberate glue detailing, distressed finishing, and exposed stitching to create a bold vintage-inspired look.\nDesigned to resemble a worn-in pair, this model delivers a strong retro character while maintaining a modern, fashion-forward edge.\nThe raised toe shape and structured heel panel highlight forward-thinking construction and unique proportions.\nCrafted to closely match the original configuration from inside out, offering premium quality and attention to detail.\nComes with full original-style box packaging.',
  flylinkUrl: 'https://store.flylinking.com/g/4114A62MSC',
  variants: [
    {
      color: 'Black',
      images: [
