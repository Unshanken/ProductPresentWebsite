...
export const AirJordanAirJordan4Product: Product = {
  id: 'product-003',
  slug: 'air-jordan-air-jordan-4',
  name: 'Air Jordan 4',
  brand: 'air-jordan',
  category: 'shoes',
  description: 'Air Jordan 4 is presented as part of the current shoe catalog, combining recognizable branding, wearable comfort and standout styling for everyday fashion use.',
