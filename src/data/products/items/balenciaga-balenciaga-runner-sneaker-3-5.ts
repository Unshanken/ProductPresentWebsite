...
export const BalenciagaBalenciagaRunnerSneaker35Product: Product = {
  id: 'product-012',
  slug: 'balenciaga-balenciaga-runner-sneaker-3-5',
  name: 'Balenciaga Runner Sneaker 3.5',
  brand: 'balenciaga',
  category: 'shoes',
  description: 'The latest Track 3.0 release featuring new colorways, including the standout rainbow series with signature gold-label detailing.\nDesigned with a bold outdoor-inspired aesthetic, this model combines layered construction with a dynamic, technical look.\nBuilt to closely match the original configuration from inside out, delivering premium quality and precise detailing.\nA statement vintage sneaker with multiple color options, offering both visual impact and everyday wearability.\nComes with full premium box packaging.',
  flylinkUrl: 'https://store.flylinking.com/g/TFGPMZQLBQ',
  variants: [
    {
      color: 'Black',
      images: [
  ...
  priceLabel: '$129.99',
  materials: [
    'Multi-layer mesh and synthetic upper',
