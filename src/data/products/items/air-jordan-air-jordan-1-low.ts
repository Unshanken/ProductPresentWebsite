...
export const AirJordanAirJordan1LowProduct: Product = {
  id: 'product-013',
  slug: 'air-jordan-air-jordan-1-low',
  name: 'Air Jordan 1 Low',
  brand: 'air-jordan',
  category: 'shoes',
  description: 'Air Jordan 1 Low is presented as part of the current shoe catalog, combining recognizable branding, wearable comfort and standout styling for everyday fashion use.',
