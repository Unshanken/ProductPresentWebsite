...
export const ChromeHeartChromeHeartLongSleeveShirtProduct: Product = {
  id: 'product-028',
  slug: 'chrome-heart-chrome-heart-long-sleeve-shirt',
  name: 'Chrome Heart Long Sleeve Shirt',
  brand: 'chrome-heart',
  category: 'tops',
  description: 'Chrome Heart Long Sleeve Shirt is included in the current tops selection for its easy-to-style fit, recognizable brand identity and versatile wardrobe appeal.',
  flylinkUrl: 'https://store.flylinking.com/g/DLIDCZYKUE',
  variants: [
    {
      color: 'Black',
      images: [
