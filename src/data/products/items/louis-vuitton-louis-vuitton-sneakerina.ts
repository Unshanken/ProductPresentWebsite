...
export const LouisVuittonLouisVuittonSneakerinaProduct: Product = {
  id: 'product-033',
  slug: 'louis-vuitton-louis-vuitton-sneakerina',
  name: 'Louis Vuitton Sneakerina',
  brand: 'louis-vuitton',
  category: 'shoes',
  description: 'Original-level accuracy (1:1 recreation) with an extremely close match in shape and detailing — crafted with precision and high-quality finishing. Constructed using premium deer leather, lambskin, and glossy panel accents. Features a breathable mesh lining for comfort, along with a calfskin leather insole. Removable insole design with original-style double insole construction. Finished with a custom TPU outsole for durability and support.',
  ...
  sizes: [
    ...
    'Women US 10 = UK 8 = EUR 42'
  ],
  featured: false,
  newArrival: false,
  priceLabel: '$129.99',
  materials: [
    'Deer leather, lambskin, and glossy panel upper',
    'Breathable mesh lining',
    'Calfskin leather insole (removable, double-layer construction)',
    'TPU outsole',
