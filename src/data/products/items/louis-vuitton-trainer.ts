...
export const LouisVuittonTrainerProduct: Product = {
  id: 'product-017',
  slug: 'louis-vuitton-trainer',
  name: 'Trainer',
  brand: 'louis-vuitton',
  category: 'shoes',
  description: 'Original-level accuracy (1:1 recreation) with a precise silhouette and refined craftsmanship. Consistently high-quality production using original-spec materials: Suede calfskin and fabric upper, breathable mesh lining, and a custom-molded TPU outsole designed to match the original.Comes with premium gift box packaging.',
  flylinkUrl: 'https://store.flylinking.com/g/NMX25172Q8',
  variants: [
    {
      color: 'Baby Blue',
      images: [
  ...
  priceLabel: '$199.99',
  materials: [
    'Suede calfskin and fabric upper',
