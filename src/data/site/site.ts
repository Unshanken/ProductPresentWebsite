...
export const siteContent: SiteContent = {
  ...
  copyright: "© 2026 themodedistrict. All rights reserved.",
  siteUrl: "https://themodedistrict.com",
  defaultOgImage:
    "https://images.unsplash.com/photo-1515886657613-9f3515b0c78f?auto=format&fit=crop&w=1200&q=80",
  flylinkStoreUrl: "",
  contact: {
    email: "kai.w@themodedistrict.com",
      ...
      highlights: [
        {
          ...
          description: "Get the look and feel of high-end fashion at a fraction of the price, without compromising on style."
        },
        {
          label: "Products",
          value: "Hot Styles",
          description: "Discover best-selling sneakers, apparel and accessories inspired by top luxury and street brands."
        },
        {
          label: "Order",
          value: "Fast Response",
          description: "Contact us anytime to get product details, pricing and quick order support."
        }
      ]
    },
    brandShowcase: {
